...
class SurvivalIndexMissionEnum(Enum):
    ...
    BUG_1_XZLF_1 = SurvivalIndexMission(cate=SurvivalIndexCategoryEnum.BUD_1.value, tp=map_const.P02_R02_SP04, sub_cate=SurvivalIndexSubCategoryEnum.BUD_1_XZLF.value, power=10)  # TODO
