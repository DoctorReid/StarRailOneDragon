...
class GuideTabEnum(Enum):
    ...
    TAB_1 = GuideTab(cn='行动摘要', num=1, rect=Rect(300, 170, 430, 245), area=ScreenGuide.GUIDE_TAB_1.value)
    TAB_2 = GuideTab(cn='每日实训', num=2, rect=Rect(430, 170, 545, 245), area=ScreenGuide.GUIDE_TAB_2.value)
    TAB_3 = GuideTab(cn='生存索引', num=3, rect=Rect(545, 170, 650, 245), area=ScreenGuide.GUIDE_TAB_3.value)
