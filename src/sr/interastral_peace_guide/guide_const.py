    ...
    def ui_cn(self) -> str:
        ...
        if self.cate == GuideCategoryEnum.BUD_1.value:
            ...
            if self.tp in [map_const.P01_R02_SP03, map_const.P03_R09_SP04, map_const.P04_R03_SP05]:
                prefix = '量子'
            elif self.tp in [map_const.P02_R11_SP04, map_const.P03_R08_SP05, map_const.P04_R10_SP11]:
                prefix = '风'
            ...
            if self.tp == map_const.P01_R03_SP06:
                ...
                return '铁骑 勇烈'
            elif self.tp == map_const.P03_R11_SP13:
                return '司铎 学者'
            else:
                return self.tp.cn
...
class GuideMissionEnum(Enum):
    ...
    PATH_11 = GuideMission(cate=GuideCategoryEnum.PATH.value, tp=map_const.P03_R11_SP13, power=40)
