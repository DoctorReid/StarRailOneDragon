...
from sr.const.map_const import Planet, Region, TransportPoint
...
class ContextPosInfo:
    ...
    def __init__(self):
        ...
        注释统一使用 pos_ 前缀
        """
        self.pos_planet: Planet = None
        self.pos_region: Region = None
        self.pos_point: Point = None
    ...
    def update_pos_after_tp(self, tp: TransportPoint):
        """
        传送后 更新坐标
        :param tp: 传送点
        :return:
