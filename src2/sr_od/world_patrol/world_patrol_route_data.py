...
from sr_od.world_patrol.world_patrol_map_data import WorldPatrolMapData, Planet, Region
...
class WorldPatrolRouteData:
    ...
    def __init__(self, map_data: WorldPatrolMapData):
        self.map_data: WorldPatrolMapData = map_data
